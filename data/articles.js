window.ID_ARTICLES = [
  ...
  },
  {
    ...
    type: "AHA scientific statement / expert consensus",
    journal: "Circulation",
    impact: "Practice changing",
    tags: ["Endocarditis", "Bacteremia", "Antimicrobial therapy", "Antimicrobial duration", "Oral therapy", "Stewardship", "Diagnostics", "Imaging", "Source control", "Inpatient ID"],
    summary: "The 2026 AHA scientific statement substantially updates the 2015 infective endocarditis framework. Major practice-facing changes include abandoning routine gentamicin for staphylococcal prosthetic-valve endocarditis, counting preoperative treatment toward the planned total course rather than restarting 4-6 weeks after valve surgery, formalizing carefully selected partial oral continuation therapy after an initial IV phase, and recognizing long-acting lipoglycopeptides as off-label continuation options in selected patients. In the cited meta-analysis of 343 patients, adjunctive gentamicin did not reduce clinical failure (OR 0.98, 95% CI 0.39-2.46), nor did rifampin (OR 1.29, 95% CI 0.71-2.33), while toxicity and drug interactions were substantial.",
    change: "The writing group reached consensus that gentamicin risk outweighs potential benefit in staphylococcal PVE, but did not reach consensus on rifampin. After valve surgery, patients who have not completed treatment should receive the planned 4-6-week total course with preoperative days counted, provided at least 14 postoperative days are given; positive valve culture or molecular testing does not by itself reset duration. Staphylococcal NVE that undergoes valve replacement can continue a native-valve regimen rather than automatically converting to a prosthetic-valve combination regimen. For VGS or S. gallolyticus IE with intermediate penicillin susceptibility, ceftriaxone monotherapy is supported when the ceftriaxone MIC is <=0.5 mg/L. Colonoscopy is considered reasonable for E. faecalis IE as well as S. gallolyticus IE.",
    takeaway: "Use this statement as the new AHA framework for adult IE, while recognizing it is a scientific statement rather than a formally graded guideline. Stop treating gentamicin as routine staphylococcal PVE therapy, individualize rifampin, do not restart the antibiotic clock after valve surgery, and consider oral or long-acting continuation only after clinical stabilization and endocarditis-team review. The current PDF's Table 1 line listing 4 weeks for staphylococcal native-valve IE is a known typo under correction and is not treated here as a new duration recommendation.",
    limitations: "This is an AHA scientific statement rather than a formal guideline with graded recommendations. Consensus was sought but was not mandatory, and many practice suggestions rely on observational cohorts, retrospective studies, meta-analyses of nonrandomized data, or expert judgment. Partial oral therapy remains restricted to carefully selected stable patients; POET excluded about 80% of screened patients. Long-acting lipoglycopeptides remain off-label for IE and have limited comparative evidence. The current source PDF contains the staphylococcal NVE 4-week table typo noted above, so that line should not be operationalized pending the corrected version.",
    link: "https://www.ahajournals.org/doi/10.1161/CIR.0000000000001466",
  ...
  },
  {
    ...
    change: "The primary safety composite included death, unplanned cardiac surgery, and symptomatic embolism; it excluded relapse. Relapse of bacteremia or endocarditis was a key secondary endpoint and occurred in 13/255 (5.1%) with shortened treatment versus 4/253 (1.6%) with standard treatment (P=.04). Noninferiority for the safety composite therefore does not establish equivalent infection control.",
    takeaway: "Do not routinely shorten left-sided endocarditis treatment on the basis of composite noninferiority. Any individualized discussion of earlier stopping requires confirmation of the final trial protocol's stabilization criteria and minimum treatment duration, with explicit counseling about the higher observed relapse rate. Clinical stability alone is insufficient to apply this strategy.",
    limitations: "The trial was open-label and randomized patients only after substantial initial therapy and clinical stabilization. The 7.5-percentage-point noninferiority margin applied to a composite that excluded relapse; its confidence interval still allowed up to a 2.7-percentage-point increase in that composite. These results do not justify routine early stopping or extrapolation beyond the selected S. aureus, E. faecalis, and streptococcal population.",
